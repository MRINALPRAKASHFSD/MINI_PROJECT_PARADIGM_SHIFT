...
async function seed() {
  ...
  // ── USERS ──
  const usersData = [
    { name: 'Vikram Patel', email: 'admin@paradigmshift.com', password: adminPw, role: 'admin', employeeId: 'ADM001', department: 'Engineering', designation: 'CTO & Admin', salary: 180000, phone: '+91 98765 10001', joiningDate: new Date('2021-01-15'), leaveBalances: { casual: 12, earned: 15, sick: 10, total: 37 } },
    { name: 'Ananya Gupta', email: 'hr@paradigmshift.com', password: adminPw, role: 'hr', employeeId: 'HR001', department: 'Human Resources', designation: 'HR Director', salary: 120000, phone: '+91 98765 10002', joiningDate: new Date('2021-06-01'), leaveBalances: { casual: 12, earned: 15, sick: 10, total: 37 } },
    { name: 'Rajesh Kumar', email: 'rajesh.kumar@paradigmshift.com', password: hashedPw, role: 'employee', employeeId: 'EMP001', department: 'Engineering', designation: 'Senior Developer', salary: 95000, phone: '+91 98765 43210', joiningDate: new Date('2023-03-15'), leaveBalances: { casual: 12, earned: 15, sick: 10, total: 37 } },
    { name: 'Priya Sharma', email: 'priya.sharma@paradigmshift.com', password: hashedPw, role: 'employee', employeeId: 'EMP002', department: 'Marketing', designation: 'Marketing Lead', salary: 85000, phone: '+91 98765 43211', joiningDate: new Date('2022-06-20'), leaveBalances: { casual: 12, earned: 15, sick: 10, total: 37 } },
    { name: 'Rohit Saxena', email: 'rohit.saxena@paradigmshift.com', password: hashedPw, role: 'employee', employeeId: 'EMP003', department: 'Engineering', designation: 'Full Stack Developer', salary: 75000, phone: '+91 98765 43212', joiningDate: new Date('2023-01-10'), leaveBalances: { casual: 12, earned: 15, sick: 10, total: 37 } },
    { name: 'Diya Sharma', email: 'diya.sharma@paradigmshift.com', password: hashedPw, role: 'employee', employeeId: 'EMP004', department: 'Engineering', designation: 'Frontend Developer', salary: 70000, phone: '+91 98765 43213', joiningDate: new Date('2023-05-30'), leaveBalances: { casual: 12, earned: 15, sick: 10, total: 37 } },
    { name: 'Arjun Reddy', email: 'arjun.reddy@paradigmshift.com', password: hashedPw, role: 'employee', employeeId: 'EMP005', department: 'R&D', designation: 'Research Analyst', salary: 72000, phone: '+91 98765 43214', joiningDate: new Date('2023-04-22'), leaveBalances: { casual: 12, earned: 15, sick: 10, total: 37 } },
    { name: 'Sneha Iyer', email: 'sneha.iyer@paradigmshift.com', password: hashedPw, role: 'employee', employeeId: 'EMP006', department: 'Human Resources', designation: 'HR Executive', salary: 55000, phone: '+91 98765 43215', joiningDate: new Date('2023-05-30'), leaveBalances: { casual: 12, earned: 15, sick: 10, total: 37 } },
    { name: 'Mahin Khan', email: 'mahin.khan@paradigmshift.com', password: hashedPw, role: 'employee', employeeId: 'EMP007', department: 'Finance', designation: 'Financial Analyst', salary: 68000, phone: '+91 98765 43216', joiningDate: new Date('2022-09-05'), leaveBalances: { casual: 12, earned: 15, sick: 10, total: 37 } },
    { name: 'Rohan Kapoor', email: 'rohan.kapoor@paradigmshift.com', password: hashedPw, role: 'employee', employeeId: 'EMP008', department: 'Sales', designation: 'Sales Manager', salary: 78000, phone: '+91 98765 43217', joiningDate: new Date('2022-08-14'), leaveBalances: { casual: 12, earned: 15, sick: 10, total: 37 } },
    { name: 'Kavita Deshmukh', email: 'kavita.deshmukh@paradigmshift.com', password: hashedPw, role: 'employee', employeeId: 'EMP009', department: 'Legal', designation: 'Legal Advisor', salary: 82000, phone: '+91 98765 43218', joiningDate: new Date('2022-07-25'), leaveBalances: { casual: 12, earned: 15, sick: 10, total: 37 } },
    { name: 'Deepika Nair', email: 'deepika.nair@paradigmshift.com', password: hashedPw, role: 'employee', employeeId: 'EMP010', department: 'Design', designation: 'UI/UX Designer', salary: 65000, phone: '+91 98765 43219', joiningDate: new Date('2023-08-01'), leaveBalances: { casual: 12, earned: 15, sick: 10, total: 37 } },
  ];
