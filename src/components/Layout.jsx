...
import { 
  ...
  Sparkles,
  Zap,
  Target  // ✨ NEW: Added for Progress Card
} from 'lucide-react';
import './Layout.css';
...
const Layout = () => {
  ...
  // ✨ UPDATED: Added badge property to menu items
  const menuItems = [
    { 
      path: '/dashboard', 
      ...
      particles: '✨',
      badge: null  // ✨ NEW: No badge for dashboard
    },
    { 
      path: '/teams', 
      icon: Users, 
      ...
      particles: '👥',
      badge: 3  // ✨ NEW: 3 team notifications
    },
    { 
      path: '/tasks', 
      icon: CheckSquare, 
    ...
    { 
      ...
      particles: '📸',
      badge: 5  // ✨ NEW: 5 proofs to submit
    },
    { 
      path: '/reports', 
      icon: FileText, 
    ...
    <div className={`layout-container ${darkMode ? 'dark' : 'light'}`}>
      ...
      >
        ...
        <div className="sidebar-header">
          ...
          >
            <motion.div 
              ...
              transition={{ 
                rotateY: { duration: 4, repeat: Infinity, repeatDelay: 3 },
        ...
        <nav className="sidebar-nav">
          {menuItems.map((item, index) => {
            ...
            return (
              <motion.button
                key={item.path}
                data-label={item.label}  // ✨ Added for tooltip
        ...
        <div className="sidebar-footer">
          ...
          <motion.button
            className="nav-item"
            data-label="Settings"  // ✨ Added for tooltip
          ...
          <motion.button
            ...
            data-label="Logout"  // ✨ Added for tooltip
